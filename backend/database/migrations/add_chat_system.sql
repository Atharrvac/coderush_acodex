...
CREATE TABLE IF NOT EXISTS help_sessions (
    ...
    distance_to_problem DECIMAL(10, 2), -- in km
...
CREATE INDEX idx_help_sessions_problem ON help_sessions(problem_id);
CREATE INDEX idx_help_sessions_helper ON help_sessions(helper_id);
CREATE INDEX idx_help_sessions_poster ON help_sessions(poster_id);
CREATE INDEX idx_help_sessions_status ON help_sessions(status);
CREATE INDEX idx_help_sessions_started ON help_sessions(started_at DESC);
...
-- Session updates indexes
CREATE INDEX idx_session_updates_session ON session_updates(session_id);
CREATE INDEX idx_session_updates_type ON session_updates(update_type);
CREATE INDEX idx_session_updates_created ON session_updates(created_at DESC);
...
-- This will be populated automatically when users interact

-- =====================================================
-- MIGRATION COMPLETE
-- =====================================================

COMMENT ON TABLE help_sessions IS 'Active help sessions tracking from start to completion';
COMMENT ON TABLE chat_messages IS 'Real-time chat messages between helper and poster';
COMMENT ON TABLE session_updates IS 'Important events and updates during help session';
