-- ============================================
-- SMART FIX - Discovers your table structure and adapts
...
-- Step 5: Clear achievements and insert with ONLY the columns that exist
-- We'll use a dynamic approach that works with any table structure
TRUNCATE TABLE achievements CASCADE;

-- Insert achievements using ONLY the required 'code' column and common columns
-- This will work regardless of what other columns exist
DO $$
DECLARE
  has_category BOOLEAN;
  has_points BOOLEAN;
  has_badge_color BOOLEAN;
BEGIN
  ...
  ) INTO has_badge_color;
  
  -- Insert based on what columns exist
  IF has_category AND has_points AND has_badge_color THEN
    -- All columns exist
    ...
    ('speed_demon', 'helping', 'Speed Demon', 'Respond in under 5 minutes', 'flash', 100, 'yellow'),
    ...
    ('good_samaritan', 'helping', 'Good Samaritan', 'Maintain 4.5+ rating', 'heart', 1000, 'red'),
    ('night_owl', 'helping', 'Night Owl', 'Help between 10 PM - 6 AM', 'moon', 50, 'indigo'),
    ('early_bird', 'helping', 'Early Bird', 'Help between 5 AM - 8 AM', 'sunny', 50, 'yellow'),
    ('weekend_warrior', 'helping', 'Weekend Warrior', 'Help 5 people on weekends', 'calendar', 200, 'green');
  ELSIF has_points AND has_badge_color THEN
    -- No category, but has points and badge_color
    INSERT INTO achievements (code, name, description, icon, points, badge_color) VALUES
    ('first_responder', 'First Responder', 'Help with your first problem', 'hand-left', 0, 'green'),
    ('problem_solver', 'Problem Solver', 'Solve 5 problems', 'checkmark-circle', 250, 'blue'),
    ('community_helper', 'Community Helper', 'Help 10 people', 'people', 500, 'purple'),
    ('speed_demon', 'Speed Demon', 'Respond in under 5 minutes', 'flash', 100, 'yellow'),
    ('local_hero', 'Local Hero', 'Solve 25 problems in your area', 'star', 1250, 'gold'),
    ('civic_champion', 'Civic Champion', 'Post 10 problems that get solved', 'trophy', 500, 'orange'),
    ('good_samaritan', 'Good Samaritan', 'Maintain 4.5+ rating', 'heart', 1000, 'red'),
    ('night_owl', 'Night Owl', 'Help between 10 PM - 6 AM', 'moon', 50, 'indigo'),
    ('early_bird', 'Early Bird', 'Help between 5 AM - 8 AM', 'sunny', 50, 'yellow'),
    ('weekend_warrior', 'Weekend Warrior', 'Help 5 people on weekends', 'calendar', 200, 'green');
  ELSE
    -- Minimal columns - just code, name, description, icon
    INSERT INTO achievements (code, name, description, icon) VALUES
    ('first_responder', 'First Responder', 'Help with your first problem', 'hand-left'),
    ('problem_solver', 'Problem Solver', 'Solve 5 problems', 'checkmark-circle'),
    ('community_helper', 'Community Helper', 'Help 10 people', 'people'),
    ('speed_demon', 'Speed Demon', 'Respond in under 5 minutes', 'flash'),
    ('local_hero', 'Local Hero', 'Solve 25 problems in your area', 'star'),
    ('civic_champion', 'Civic Champion', 'Post 10 problems that get solved', 'trophy'),
    ('good_samaritan', 'Good Samaritan', 'Maintain 4.5+ rating', 'heart'),
    ('night_owl', 'Night Owl', 'Help between 10 PM - 6 AM', 'moon'),
    ('early_bird', 'Early Bird', 'Help between 5 AM - 8 AM', 'sunny'),
    ('weekend_warrior', 'Weekend Warrior', 'Help 5 people on weekends', 'calendar');
  END IF;
END $$;
...
-- ============================================
-- SUCCESS! This smart fix adapts to your table structure!
-- It checks what columns exist and inserts accordingly.
-- ============================================
